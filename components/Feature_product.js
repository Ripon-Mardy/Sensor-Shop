    ...
    return (
        <div>
            ...
            <div className='md:flex md:items-center md:justify-between'>
                ...
                <Link href={'/products'} className=' font-medium capitalize text-sm bg-navBgColor text-white p-1.5 rounded-sm hidden md:block hover:bg-hoverNavBgColor duration-200 ease-in-out'>view all Featured products</Link>
            </div>
            ...
            <div>
                ...
                <Link href={'/products'} className=' font-medium capitalize text-sm bg-navBgColor text-white p-1.5 rounded-sm hover:bg-hoverNavBgColor duration-200 ease-in-out md:hidden mt-6 inline-block'>view all Featured products</Link>
            </div>
